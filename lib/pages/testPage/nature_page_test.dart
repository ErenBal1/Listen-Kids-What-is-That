...
class NaturePageTest extends StatefulWidget {
  const NaturePageTest({super.key});

  @override
  State<NaturePageTest> createState() => _NaturePageTestState();
}

class _NaturePageTestState extends State<NaturePageTest> {
  ...
  void _playSoundAutomatically() {
    ...
    _timer = Timer(autoPlayDuration, () async {
      String audioPath = ("sounds/nature/${animals[dogruCevapIndex]}.mp3");
          ...
          Center(
            child: FloatingActionButton.large(
              ...
              onPressed: () async {
                ...
                String audioPath =
                    ("sounds/nature/${animals[dogruCevapIndex]}.mp3");
                await player.play(AssetSource(audioPath));
  ...
  void _restartPage() {
    Future.delayed(const Duration(milliseconds: 600), () {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (BuildContext context) => const NaturePageTest(),
        ),
      );
    });
  }
